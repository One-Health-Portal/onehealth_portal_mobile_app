...
import { appointmentService, paymentService } from "../services/api.service";

const AppointmentPaymentScreen = ({ route, navigation }) => {
  const { doctor, hospital, selectedDate, selectedTime } = route.params;
  ...
  // Calculate fees
  const consultationFee = doctor.consultation_fee || 2500.0;
  const serviceFee = consultationFee * 0.2; // 20% service fee
  ...
  const handleBooking = async () => {
    try {
      ...
      const appointmentData = {
        ...
        appointment_date: adjustedDate.toISOString().split("T")[0],
      ...
      if (appointmentResponse && appointmentResponse.appointment_id) {
        // Create payment record
        const paymentData = {
          appointment_id: appointmentResponse.appointment_id,
          amount: totalAmount,
          payment_date: new Date().toISOString(),
          payment_status: "Pending", // Set as pending since it's pay at hospital
        };
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Processing your appointment...</Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.paymentSection}>
          ...
          <View style={styles.paymentItem}>
            <Text style={styles.paymentLabel}>Service Fee (20%)</Text>
            <Text style={styles.paymentAmount}>
        ...
        <View style={styles.methodSection}>
          ...
          <View style={styles.methodCard}>
            ...
            <Text style={styles.methodText}>Pay at Hospital</Text>
          </View>
        </View>
        ...
        <View style={styles.noticeSection}>
          ...
          <Text style={styles.noticeText}>
            ...
            valid ID and insurance card (if applicable){"\n"}• Payment to be
            made at the hospital counter{"\n"}• Cancellation should be made 24
            hours prior
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          style={[styles.appointmentButton, loading && styles.disabledButton]}
        ...
        >
          {loading ? (
            ...
            <>
              <Text style={styles.appointmentButtonText}>Confirm Booking</Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalMessage}>
              Your appointment has been successfully booked. Please make the
              payment at the hospital counter before your consultation.
            </Text>
            <TouchableOpacity
